...
import (
	...
	bls123812 "github.com/nickeskov/anonymous-transactions-prototype/zkgo/pkg/crypto/groth16/bls12381"
	bn2562 "github.com/nickeskov/anonymous-transactions-prototype/zkgo/pkg/crypto/groth16/bn256"
)
...
func (Bls12381) Groth16Verify(vk []byte, proof []byte, inputs []byte) (bool, error) {
	...
	vkT, err := bls123812.GetVerificationKeyFromCompressed(vk)
	if err != nil {
		return false, err
	}
	proofT, err := bls123812.GetProofFromCompressed(proof)
	if err != nil {
		return false, err
	}
	...
	return bls123812.ProofVerify(vkT, proofT, inputsFr)
}
...
func (Bn256) Groth16Verify(vk []byte, proof []byte, inputs []byte) (bool, error) {
	...
	vkT, err := bn2562.GetVerificationKeyFromCompressed(vk)
	if err != nil {
		return false, err
	}
	proofT, err := bn2562.GetProofFromCompressed(proof)
	if err != nil {
		return false, err
	}
	inputsFr, err := ReadInputs(inputs)
	...
	return bn2562.ProofVerify(vkT, proofT, inputsFr)
